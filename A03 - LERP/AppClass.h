...
class Application
{
	...
	std::vector<std::vector<vector3>> m_stopsList; //list of stops for the spheres around the shapes
	std::vector<int> m_lastStops; //tracker of what the last stop was for each sphere
